...
const DEFAULT_CATEGORIES = [
  ...
  { type: 'expense', name: '쇼핑·미용', icon: '🛍', color: '#B5EAD7', sort_order: 3,  subs: ['의류','생활용품','온라인쇼핑','미용'] },
  { type: 'expense', name: '의료·건강', icon: '💊', color: '#C7E8A0', sort_order: 4,  subs: ['병원','약국','헬스·운동','보험'] },
